...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Bargazal and Sons Tech Solution - Business Software" },
    ...
    links: [
      ...
      { rel: "icon", href: "/company-logo.png", type: "image/png" },
      { rel: "shortcut icon", href: "/company-logo.png", type: "image/png" },
      { rel: "apple-touch-icon", href: "/company-logo.png" },
    ],
  }),
